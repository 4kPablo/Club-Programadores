      ...
      <div className='modal-dialog modal-dialog-centered form-container w-50 modal-lg'>
        <div className="modal-content">
          <div className="modal-header">
            ...
            <button onClick={onClose} type="button" className="btn-close cursor-pointer" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <form onSubmit={handleSubmit}>
            <div className="modal-body d-flex flex-column flex-lg-row gap-4">
              ...
              <section className='skills-interests-container  w-100'>
                <div className='form-group'>
                  <h3>Tus Skills</h3>
                  {['HTML', 'JavaScript', 'React', 'NodeJS', 'Blender', 'Godot', 'Unity', 'SPARQL'].map(skill => (
                    <div key={skill} className="form-check">
                      ...
                      />
                      <label className="form-check-label" htmlFor={skill.toLowerCase()}>{skill}</label>
                    </div>
                  ))}
                </div>
            ...
            <div className="modal-footer">
              ...
              <button type="submit" className="btn btn-success">¡Sumarme!</button>
            </div>
          </form>
        </div>
      </div>
